...
To build from source: `docker build -t warehouse-inventory:1.1.0 .` Then use the same run command above. See [deployment and backup](docs/DOCKER_DEPLOYMENT.md), [administration](docs/ADMINISTRATION.md), [Power Automate setup](docs/POWER_AUTOMATE.md), and [local development](docs/INSTALL.md).
